...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let mut mgr = CustomModelManager::new("groq").with_strategy(ModelSelectionStrategy::PerformanceBased);
    ...
    mgr.add_model(ModelInfo {
        ...
        capabilities: ModelCapabilities::new().with_chat().with_context_window(131072),
    ...
    mgr.add_model(ModelInfo {
        ...
        capabilities: ModelCapabilities::new().with_chat().with_context_window(8192),
    ...
    println!("Selected model: {} ({})", selected.display_name, selected.name);
