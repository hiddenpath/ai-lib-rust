//! AI-Protocol compliance test runner (shared by `ai-lib-core` and facade `ai-lib-rust`).
//!
...
fn compliance_dir() -> PathBuf {
    ...
    // Try common sibling layouts (facade crate + core crate under `crates/ai-lib-core`).
